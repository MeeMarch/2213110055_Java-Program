...
public class TempConversion extends JFrame {
	...
	public TempConversion() {
		...
		FahHandler farenheitHandler = new FahHandler();
		tfFahrenheit.addActionListener(farenheitHandler);
	...
	private class CelsHandler implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			tfFahrenheit.setText(String.format("%.2f", farenheit));
		}
	}
	...
	private class FahHandler implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			double celsius,farenheit;
			farenheit = Double.parseDouble(tfFahrenheit.getText());
